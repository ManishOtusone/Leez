...
import BuyHouse from "../../assets/Images/RentFast.png";
...
const SellAndRent = () => {
    ...
    return (
        <ExploreAndNews
            ...
            exploreTitle="Rent faster at the right price!"
            exploreText="List your property now"
            buttonText="Post Property"
            articleSectionTitle="Articles and guides for property owners"
